...
namespace VRC_Favourite_Manager
{
    ...
    /// </summary>
    public interface IMyAuthenticationAPISync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMyAuthenticationAPIAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMyAuthenticationAPI : IMyAuthenticationAPISync, IMyAuthenticationAPIAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MyAuthenticationAPI : IMyAuthenticationAPI
    {
        private VRChat.API.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MyAuthenticationAPI"/> class.
        /// </summary>
        /// <returns></returns>
        public MyAuthenticationAPI() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public MyAuthenticationAPI(string basePath)
        {
        ...
        /// <returns></returns>
        public MyAuthenticationAPI(VRChat.API.Client.Configuration configuration)
        {
        ...
        public MyAuthenticationAPI(VRChat.API.Client.ISynchronousClient client, VRChat.API.Client.IAsynchronousClient asyncClient, VRChat.API.Client.IReadableConfiguration configuration)
        {
        ...
        public VRChat.API.Client.ApiResponse<UserExists> CheckUserExistsWithHttpInfo(string email = default(string), string displayName = default(string), string userId = default(string), string excludeUserId = default(string), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "MyAuthenticationAPI.CheckUserExists";
        ...
        public VRChat.API.Client.ApiResponse<CurrentUser> DeleteUserWithHttpInfo(string userId, int operationIndex = 0)
        {
            ...
            if (userId == null)
            {
                throw new VRChat.API.Client.ApiException(400, "Missing required parameter 'userId' when calling MyAuthenticationAPI->DeleteUser");
            }
            ...
            localVarRequestOptions.Operation = "MyAuthenticationAPI.DeleteUser";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public VRChat.API.Client.ApiResponse<CurrentUser> GetCurrentUserWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "MyAuthenticationAPI.GetCurrentUser";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public VRChat.API.Client.ApiResponse<Success> LogoutWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "MyAuthenticationAPI.Logout";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public VRChat.API.Client.ApiResponse<Verify2FAResult> Verify2FAWithHttpInfo(TwoFactorAuthCode twoFactorAuthCode, int operationIndex = 0)
        {
            ...
            {
                throw new VRChat.API.Client.ApiException(400, "Missing required parameter 'twoFactorAuthCode' when calling MyAuthenticationAPI->Verify2FA");
            }
            ...
            localVarRequestOptions.Operation = "MyAuthenticationAPI.Verify2FA";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        {
            Debug.WriteLine("Starting Verify2FAEmailCode");
            // verify the required parameter 'twoFactorEmailCode' is set
            if (twoFactorEmailCode == null)
            {
                throw new VRChat.API.Client.ApiException(400, "Missing required parameter 'twoFactorEmailCode' when calling MyAuthenticationAPI->Verify2FAEmailCode");
            }
            ...
            localVarRequestOptions.Operation = "MyAuthenticationAPI.Verify2FAEmailCode";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (!string.IsNullOrEmpty(this.Configuration.GetApiKeyWithPrefix("auth")))
            {
                var authCookie = new Cookie("auth", this.Configuration.GetApiKeyWithPrefix("auth"))
                {
                    Domain = "https://vrchat.com/" // Set the domain explicitly
                };
                localVarRequestOptions.Cookies.Add(authCookie);
            }
        ...
        public VRChat.API.Client.ApiResponse<VerifyAuthTokenResult> VerifyAuthTokenWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "MyAuthenticationAPI.VerifyAuthToken";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public VRChat.API.Client.ApiResponse<Verify2FAResult> VerifyRecoveryCodeWithHttpInfo(TwoFactorAuthCode twoFactorAuthCode, int operationIndex = 0)
        {
            ...
            if (twoFactorAuthCode == null)
            {
                throw new VRChat.API.Client.ApiException(400, "Missing required parameter 'twoFactorAuthCode' when calling MyAuthenticationAPI->VerifyRecoveryCode");
            }
            ...
            localVarRequestOptions.Operation = "MyAuthenticationAPI.VerifyRecoveryCode";
            localVarRequestOptions.OperationIndex = operationIndex;
